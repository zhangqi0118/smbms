...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>出生日期：</strong><span>${user.stringBirthday }</span></p>
            <p><strong>用户电话：</strong><span>${user.phone }</span></p>
            <p><strong>用户地址：</strong><span>${user.address }</span></p>
            <p><strong>用户角色：</strong><span>${user.role.getRoleName()}</span></p>
            <p>  <img id="img" style="width: 100px;height: 100px;margin-left: 110px"  src="${user.idPicPath}"/></div></p>
