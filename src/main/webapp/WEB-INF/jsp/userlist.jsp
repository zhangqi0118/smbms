<%@ page import="com.smbms.util.Constants" %>
<%@ page language="java" contentType="text/html; charset=UTF-8"
		 pageEncoding="UTF-8"%>
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
<%
if(request.getAttribute("roleList")==null) request.getRequestDispatcher("/getRole").forward(request,response);
%>
        <div class="right">
            <div class="location">
            ...
            <div class="search">
           		<form method="post" action="${pageContext.request.contextPath }/getUserByUserNameAndroleName">
				...
				<tr >
                   ...
                   <c:forEach var="user" items="${list}" varStatus="status">
					<tr>
						...
						<span><a class="deleteUser" href="javascript:;" userid=${user.id } sessionId=${userSession.id} username=${user.userName }><img src="${pageContext.request.contextPath }/images/schu.png" alt="删除" title="删除"/></a></span>
						</td>
					</tr>
				</c:forEach>
			</table>
			<input type="hidden" id="totalPageCount" value="${pageInfo.pages}"/>
		  	<c:import url="rollpage.jsp">
	          	...
	          	<c:param name="totalPageCount" value="${pageInfo.total}"/>
          	</c:import>
        </div>
